...
import com.demo.demos.FindU.Camera.utils.CommonUtil;
...
public class BaseFilter {
    ...
    public void bindTexture(){
        Log.d("BaseFilter", "------------------bindTexture()---------------------");
        glActiveTexture(GL_TEXTURE0);
        //CameraFilter调用下面getTextureId()[0]是Render中的CameraTexture
        //ColorFilter调用下面getTextureId()[0]是CameraFilter中帧缓冲区附着的纹理
        Log.d("BASE", "GL_TEXTURE_2D");
